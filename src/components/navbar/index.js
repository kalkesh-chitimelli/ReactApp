...
const Navbar = ({ reloadnavbar }) => {
  ...
  const [goToCart, setGoToCart] = useState("/cart");
  ...
  useEffect(() => {
    login === "true" ? setGoToCart("/cart") : setGoToCart("/login");
  }, [login]);
    ...
    <nav>
      <div className="s1">
        ...
        <div className="right-icons">
          <div className="cart-icon">
            ...
            <Link to={goToCart} className="stylenone">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
      ...
      <div className="s2">
        ...
        <Dropdown>
          ...
          <Dropdown.Menu>
            <Dropdown.Item href="/generalItems">Fresh Vegetables</Dropdown.Item>
